...
Component({
  options: {
    pureDataPattern: /^_/,
    multipleSlots: true,
    //NOTE: by default, only component wxss works 
  },
  /**
  ...
  properties: {
    ...
    windowHeight:{
      type: Number,
      value: app.globalData.windowHeight,
    },
    screenHeight:{
      type: Number,
      value: app.globalData.screenHeight,
    },
  ...
  lifetimes: {
    ...
    attached: function(){
      //get the window height of the page
      const res = wx.getSystemInfoSync();
      let windowHeight = res.windowHeight;
      let deadSpace = res.statusBarHeight + 44;
      //NOTE: my weui-tabs should start after deadspace, thus height is windowHeight-deadspace
      let tabsHeight = windowHeight - deadSpace;
      //upload the height fo weui-tabs to data so it will cover entire window
      this.setData({tabsHeight});
